...
class ProductionWork(CoreModel):
    code_package = models.ForeignKey(CodePackage, db_constraint=False, on_delete=models.CASCADE,
    ...
    production_line = models.ForeignKey(ProductionLine, db_constraint=False, on_delete=models.CASCADE,
