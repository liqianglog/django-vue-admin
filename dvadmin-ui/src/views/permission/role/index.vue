...
<script>
import { listRole, getRole, delRole, addRole, updateRole, exportRole, dataScope, changeRoleStatus } from "@/api/permission/role";
import { treeselect as menuTreeselect, roleMenuTreeselect } from "@/api/permission/menu";
import { treeselect as deptTreeselect, roleDeptTreeselect } from "@/api/permission/dept";
